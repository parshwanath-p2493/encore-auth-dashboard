...
type Users struct {
	...
	ExpireTimeToken         time.Time `bson:"expiretimetoken,omitempty" json:"expiretimetoken,omitempty" `
	ExptreTimeRefresh_Token time.Time `bson:"expiretimerefresh_token,omitempty" json:"expiretimerefresh_token,omitempty"`
